...
### 🧪 Junior Manual QA Tester | API Testing | Regression | Defect Reporting

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=20&duration=2800&pause=800&color=58A6FF&center=true&vCenter=true&width=700&lines=Manual+QA+Testing;Functional+%7C+UI+%7C+Regression+Testing;API+Testing+with+Postman;Defect+Reporting+%26+Retesting;Web+%26+SEO+Quality+Assurance" alt="Typing animation" />
...
Junior Manual QA Tester focused on **functional testing, UI validation, regression testing, API testing, defect reporting, and structured QA documentation**.

I turn requirements into test coverage, identify reproducible defects, validate fixes, and support reliable releases.
...
### 🔌 API Testing — Postman
REST API testing covering authentication, positive and negative testing, status-code validation, and request/response checks.
...
**API Testing** — Postman · REST APIs · GET/POST/PUT/DELETE · Status Codes · Authentication · Request/Response Validation
...
**Tools & Technical** — Jira · ClickUp · GitHub · Chrome DevTools · Excel · Google Sheets · SQL Basics · Java Basics · Selenium WebDriver

---

## 🔄 QA Workflow

**Requirements → Test Scenarios → Test Cases → Execution → Defect Reporting → Retesting → Regression Testing → Release Validation**

---

## 🐞 Defect Reporting

I focus on defects that are **clear, reproducible, actionable, evidence-based, prioritized, and traceable**.
